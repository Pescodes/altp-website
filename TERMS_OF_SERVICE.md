...
### 3. User Privacy & Data Responsibility
* **No Developer Access:** The Extension is designed to operate without transmitting your personal profile data to the Developer. We do not see, collect, or store your form-fill data.
* **Local Management:** You are solely responsible for the data you enter. Using the "Clear" function permanently deletes data from your sync storage. The Developer is not liable for data loss due to browser corruption, uninstallation, or device theft.
...
* **Refunds:** All purchases of Alt+P Autofill are eligible for full refund within 30 days of the original purchase date, no questions asked. Refund requests are handled directly by Paddle through their support channels.
  
### 6. Limitation of Liability
To the maximum extent permitted by law, the Developer shall not be liable for:
* Incorrect data entry or form submission errors.
* Loss of data or business interruption.
* Any indirect, incidental, or consequential damages.
* **Financial Cap:** In no event shall the Developer’s total liability exceed the amount actually paid by you for the license during the 12 months preceding the claim.

### 7. Indemnification
You agree to indemnify, defend, and hold harmless the Developer from and against any claims, liabilities, damages, or expenses (including legal fees) arising out of your use of the Extension, your violation of these Terms, or your infringement of any third-party rights.

### 8. Termination
We reserve the right to revoke your license and terminate access to the Extension immediately and without notice if:
1.  You violate any part of these Terms.
2.  You attempt to bypass or "crack" licensing mechanisms.
